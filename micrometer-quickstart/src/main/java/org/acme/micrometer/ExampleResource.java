...
public class ExampleResource {
    ...
    @GET
    @Path("random")
    @Counted(description = "How many get request to random API")
    @Timed(value = "get-random-number")
    public String getLuckyNumber() throws InterruptedException {
        Thread.sleep(200);
        return "Your random number is " + new Random().nextLong(1,100);
    }
}
